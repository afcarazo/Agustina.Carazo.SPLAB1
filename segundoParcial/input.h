...
/** \brief pone la primera letra en mayuscula y el resto en minuscula
 *
 * \param cadena char* cadena a convertir
 * \return int devulve(-1) ocurrio un error (0) si salio todo bien
 *
 */
int formatoNombre(char* cadena);
